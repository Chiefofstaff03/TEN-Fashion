...
export const OrderForm = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://ten-fashion-m1gv.onrender.com/cartItems",
          {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://ten-fashion-m1gv.onrender.com/api/orders",
        backendData,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  return (
    <form
      ...
      className="my-10 flex flex-col lg:flex-row md:flex-col gap-7 w-full justify-center h-auto"
    >
      <div className="border-[1.5px] rounded-sm h-[100%] w-[95%] md:w-[95%] lg:w-[60%] mx-auto lg:mx-0 p-8">
        ...
        <div className="mt-8">
          <div className="mb-5">
            <label
              htmlFor="email"
              className="block mb-4 ml-2 text-lg text-gray-900 dark:text-white"
            >
              Email Address
            </label>
            <input
              ...
              className="ml-1.5 bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-2xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              required
            />
          </div>
          ...
          <div className="mb-5">
            ...
            <textarea
              ...
              className="ml-1.5 block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-2xl border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div className="border-[1.5px] rounded-sm w-[95%] md:w-[95%] lg:w-[30%] mx-auto lg:mx-0 max-h-max p-8 bg-slate-300">
        ...
        <div className="mt-8">
          <label className="block mb-4 text-lg text-gray-900 dark:text-white">
            Payment Method
          </label>
          <select
            id="payment"
        ...
        <button className="border-2 rounded-full py-4 mt-5 bg-black text-white font-semibold text-xl hover:text-black hover:bg-white hover:border-black w-full">
          Place order
        </button>
      </div>
    </form>
